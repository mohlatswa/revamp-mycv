-- ======================================================================
-- Revamp MyCV — Profiles Table + Security Hardening
-- Run this SQL in your Supabase SQL Editor AFTER the initial schema.
-- ======================================================================

-- 1. User profiles — server-side role management (prevents role spoofing)
...
-- 3. Auto-create profile on signup (role always 'user' — prevents spoofing)
...
-- Users can update their own name (but NOT role or suspended)
...
-- 5. Admin policies for downloads and subscriptions
